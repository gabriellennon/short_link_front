...
const CookieConsent = () => {
  ...
  return (
    <div className="fixed max-w-2xl p-4 mx-auto bg-white border border-gray-200 md:gap-x-4 left-12 bottom-16 md:flex md:items-center rounded-2xl">
      <div className="flex items-center gap-x-4">
        <span className="inline-flex p-2 text-blue-200 rounded-lg shrink-0 bg-blue-500">
        ...
        <p className="text-sm text-gray-900">
          ...
          <Link href="/privacy" className="text-blue-500 hover:underline">Read cookies policies</Link>. 
        </p>
      </div>
      <button 
        className="text-sm w-1/2 md:w-auto font-medium bg-blue-500 rounded-lg text-white px-4 py-2.5 duration-300 transition-colors focus:outline-none"
